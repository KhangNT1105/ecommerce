...
describe('WidgetViews utils', () => {
  describe('validation', () => {
    ...
    describe('validateNumberLarger0', () => {
      test('should return undefined when value valid ', () => {
        expect(validateNumberLarger0('12')).toEqual(true);
      });
      test('should return FORM_ERROR_REQUIRED_FIELD when do not have value ', () => {
        expect(validateNumberLarger0('')).toEqual(true);
      });
      test('should return invalid data when value has character or special character ', () => {
        expect(validateNumberLarger0('abc44!')).toEqual(false);
      });
      test('should return invalid data when value is equal to 0 ', () => {
        expect(validateNumberLarger0('0')).toEqual(false);
      });
    });

    describe('validateNumberlargerMaxNumber', () => {
      test('should return undefined when value valid ', () => {
        expect(validateNumberLargerMaxNumber('12')).toEqual(true);
      });
      test('should return FORM_ERROR_REQUIRED_FIELD when do not have value ', () => {
        expect(validateNumberLargerMaxNumber('')).toEqual(true);
      });
      test('should return invalid data when value has character or special character ', () => {
        expect(validateNumberLargerMaxNumber('abc44!')).toEqual(false);
      });
      test('should return invalid data when value is greater than default max number ', () => {
        expect(validateNumberLargerMaxNumber('100000000000000')).toEqual(false);
      });
    });
    ...
    describe('validateHourFormat', () => {
      test('should return true when format is hh:mm:ss', () => {
        expect(validateHourFormat('11:22:33')).toBe(true);
      });
      test('should return false when value contains alphabet character', () => {
        expect(validateHourFormat('11:22:33aaa')).toBe(false);
      });
      test('should return false when minutes is larger than 59', () => {
        expect(validateHourFormat('11:60:33')).toBe(false);
      });
      test('should return false when seconds is larger than 59', () => {
        expect(validateHourFormat('11:11:60')).toBe(false);
      });
      test('should return false when hours is larger than 24hr', () => {
        expect(validateHourFormat('25:11:23')).toBe(false);
      });
      test('should return false when format is not correct', () => {
        expect(validateHourFormat('11-11/60')).toBe(false);
      });
    });
